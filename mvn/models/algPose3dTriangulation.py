...
class AlgPose3dTriangulation(nn.Module):
    ...
    def forward(self, nView_projMatricies, nView_points, nView_confidence):
        point_3d = multiview.triangulate_point_from_multiple_views_linear_torch(nView_projMatricies, nView_points, nView_confidence)
        return point_3d;
